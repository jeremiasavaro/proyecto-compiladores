...
\begin{itemize}
	...
	\item Las optimizaciones de división por potencia de 2 y eficiencia de memoria fueron realizadas sobre le código intermedio.
	...
	\item En la optimización de divisiones por potencia de 2, se hace uso de un ``bias'' para poder truncar a 0 los resultados de las divisiones cuando alguno de los operandos es negativo (si el resultado de la división es -0.5, sin realizar este paso el resultado quedaría en -1).
\end{itemize}
...
\begin{itemize}
	...
	\item No fue testeado en su totalidad el compilador con las optimizaciones, puede existir algun caso raro en que las optimizaciones no funcionen como deberían.
