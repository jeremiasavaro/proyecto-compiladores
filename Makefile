...
BISON   = bison
CC      = gcc
CFLAGS  = -g -Wall -O1 -fsanitize=address -fno-omit-frame-pointer -Wextra -std=c11 -I. -Ierror_handling -Itree -Iprint_utilities -Isymbol_table -Iutils -Isemantic_analyzer -Iintermediate_code
TARGET  = parser
...
SRCS = error_handling/error_handling.c tree/ast.c print_utilities/print_funcs.c symbol_table/symbol_table.c utils/utils.c utils/symbol.c semantic_analyzer/semantic_analyzer.c intermediate_code/intermediate_code.c
...
clean:
	...
	rm -f error_handling/*.o tree/*.o print_utilities/*.o symbol_table/*.o utils/*.o semantic_analyzer/*.o intermediate_code/*.o intermediate_code/*.output
	rm -f tests/output/*