...
SRCS = error_handling/error_handling.c tree/ast.c print_utilities/print_funcs.c symbol_table/symbol_table.c utils/utils.c semantic_analyzer/semantic_analyzer.c intermediate_code/intermediate_code.c
